...
#define PATACHE_SHADOW_RIGHT_HEIGHT     12
#define PATACHE_SHADOW_RIGHT_WIDTH      1
#define PATACHE_SHADOW_RIGHT_SIZE       12 // W * H
#define PATACHE_SHADOW_RIGHT_PIXELCOUNT 48 // W * H * 4
